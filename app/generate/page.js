...
const generate = () => {
    ...
    return (<>
        <ToastContainer />
        <div className="generate bg-[#F6F1DA] grid grid-cols-2  ">
            <div className="col1 flex flex-col  px-[8vw] pt-[25vh]">
                ...
                <div className="input flex-col flex my-7 gap-2">
                    ...
                    <button disabled={pic == "" || handle == "" || !Links[0] || Links[0].linktext === ""} onClick={() => { submitLinks() }} className=' bg-[#502274] hover:bg-[rgb(30,35,48)] w-[48%] mx-auto disabled:bg-gray-500 text-white rounded-full py-2 px-3.5 text-sm font-bold'>Create your BitTree</button>
                </div>
            </div>
            <div className="col2"><img src="https://assets.production.linktr.ee/auth/3289/media/banner-login-desktop.f355be949b508c58ec2d.webp" alt="Promotional Banner" className="h-[120vh] w-full object-cover" />
            </div>
        </div>
    </>
    )
