    ...
    <main>
      <section className="bg-[rgb(37,79,26)] flex flex-col md:grid grid-cols-2 px-[5vw] md:pt-[31vh] pt-[15vh] md:pb-[25vh] p-14" >
        <div className="content flex flex-col justify-start gap-7">
          ...
          <div className="btns flex flex-col md:flex-row  gap-3 md:py-5 ">
            <input value={text} onChange={(e) => { settext(e.target.value) }} className='bg-white text-[#867975] rounded-lg md:py-4.5 py-3 px-1.5 md:w-[43%] w-full font-medium' type="text" placeholder="Enter your handle" />
            <button onClick={() => { createTree() }} className='cursor-pointer hover:bg-fuchsia-400 bg-[#e9c0e9] text-[#1e2341] rounded-full  md:px-7 py-2.5 w-fit px-5 font-bold'>Claim your BitTree</button>
          </div>
        ...
        <div className="gifs  py-10 md:p-0"><img className="pl-6 h-[105%] w-[110%]" src="./home.png" alt="" /></div>
      </section>
